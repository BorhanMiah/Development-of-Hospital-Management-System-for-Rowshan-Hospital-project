                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li>
                                    <a href="{{route('appointment.appointment')}}">Appointment</a>
                                </li>

                                <li>
                                    <a href="{{route('appointment.appointmentList')}}">Appointment List</a>
                                </li>
                                ...
                                <li>
                                    <a href="{{route('diagnostic.in')}}">Diagnostics</a>
                                </li>
                               ...
                               <li>
                                    <a href="{{route('contact.cont')}}">Contacts</a>
                                </li>
                                <li>
                                <a href="component-modal.html">payment</a>
                                </li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li>
                                    <a href="{{route('presception.pas')}}">Presception</a>
                                </li>
